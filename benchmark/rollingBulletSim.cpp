...
int main(int argc, const char* argv[]) {
  ...
  rb::loggerSetup(
      benchmark::dataPath + parentDir + "bullet/" + rb::options.solverName,
...
void getParams(int argc, const char *argv[], char *yamlfile) {
  ...
  // sim specific
  rb::params.erp = yaml["solver_params"]["bullet"]["erp"].as<double>();
...
void simulationSetup() {
  ...
  if(rb::options.erpYN)
    sim->setERP(rb::params.erp, rb::params.erp, rb::params.erp);
