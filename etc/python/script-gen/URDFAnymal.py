...
head = open('urdf-template/anymal_head.txt', 'r').read()
body = open('urdf-template/anymal_body.txt', 'r').read()
tail = open('urdf-template/anymal_tail.txt', 'r').read()

max_num_row = 16     # ADJUST
out_dir = 'output/anymal'
