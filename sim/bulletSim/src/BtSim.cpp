...
BtSim::BtSim(int windowWidth, int windowHeight, float cms, SolverOption solverOption, int flags) :
    solverOption_(solverOption),
    world_(solverOption),
    benchmark::WorldRG(windowWidth, windowHeight, cms, flags) {}

BtSim::BtSim(SolverOption solverOption) :
    solverOption_(solverOption),
    world_(solverOption),
    benchmark::WorldRG() {}
...
benchmark::SingleBodyHandle BtSim::addBox(double xLength,
                                             double yLength,
                                             double zLength,
                                             double mass,
...
benchmark::SingleBodyHandle BtSim::addSphere(double radius,
                                                double mass,
                                                benchmark::CollisionGroupType collisionGroup,
                                                benchmark::CollisionGroupType collisionMask) {
  benchmark::SingleBodyHandle handle(
...
benchmark::SingleBodyHandle BtSim::addCheckerboard(double gridSize,
                                                      double xLength,
                                                      double yLength,
                                                      double reflectanceI,
...
benchmark::SingleBodyHandle BtSim::addCapsule(double radius,
                                                 double height,
                                                 double mass,
                                                 benchmark::CollisionGroupType collisionGroup,
                                                 benchmark::CollisionGroupType collisionMask) {
...
benchmark::SingleBodyHandle BtSim::addCylinder(double radius,
                                                  double height,
                                                  double mass,
                                                  benchmark::CollisionGroupType collisionGroup,
                                                  benchmark::CollisionGroupType collisionMask) {
...
ArticulatedSystemHandle BtSim::addArticulatedSystem(std::string nm,
                                                       benchmark::CollisionGroupType collisionGroup,
                                                       benchmark::CollisionGroupType collisionMask) {
...
void BtSim::integrate(double dt) {
  world_.integrate(dt);
}

void BtSim::setGravity(Eigen::Vector3d gravity) {
  world_.setGravity({gravity.x(), gravity.y(), gravity.z()});
}

void BtSim::setERP(double nonContactErp, double contactErp, double frictionErp) {
  world_.setERP(nonContactErp, contactErp, frictionErp);
}

void BtSim::updateFrame() {
...
int BtSim::getNumObject() {
  return world_.getNumObject();
}

int BtSim::getWorldNumContacts() {
  return (int)world_.getCollisionProblem()->size();
}

void BtSim::setMultipointIteration(int convexconvex, int convexplane) {
